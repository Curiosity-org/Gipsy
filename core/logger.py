...
default_filename = "logs/{time}.log".format(time=start.strftime("%d-%m-%Y_%Hh%Mm%S"))
...
DATETIME_FORMAT_COLOR = (
    f"{color.fg.blue}%d/%m/%Y{color.stop} at {color.fg.purple}%H:%M:%S{color.stop}"
)
