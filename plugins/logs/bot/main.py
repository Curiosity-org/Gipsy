...
class Logs(commands.Cog):
    ...
    async def send_embed(self, guild, embed: nextcord.Embed):
    ...
    async def on_message_delete(self, message: nextcord.Message):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_message_delete"
        ...
        embed = nextcord.Embed(
            ...
            colour=nextcord.Colour(13632027)
        )
    ...
    async def on_message_edit(self, before: nextcord.Message, after: nextcord.Message):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_message_edit"
        ...
        embed = nextcord.Embed(
            ...
            colour=nextcord.Colour(16294684)
        )
    ...
    async def on_raw_bulk_message_delete(self, payload: nextcord.RawBulkMessageDeleteEvent):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_raw_bulk_message_delete"
    ...
    async def on_invite_create(self, invite: nextcord.Invite):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_invite_create"
    ...
    async def on_invite_delete(self, invite: nextcord.Invite):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_invite_delete"
        if not await self.has_logs(invite.guild):
            return
        if 'invites' not in self.get_flags(invite.guild.id):
            return
    ...
    async def on_member_join(self, member: nextcord.Member):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_member_join"
        await self.on_member_join_remove(member, True)

    @commands.Cog.listener()
    async def on_member_remove(self, member: nextcord.Member):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_member_remove"
        await self.on_member_join_remove(member, False)

    async def on_member_join_remove(self, member: nextcord.Member, join: bool):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_invite_delete"
        ...
        if join:
            ...
            embed = nextcord.Embed(
                ...
                colour=nextcord.Colour(15994684)
            )
    ...
    async def on_member_ban(self, guild: nextcord.Guild, user: nextcord.User):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_member_ban"
        if not await self.has_logs(guild):
            return
    ...
    async def on_member_unban(self, guild: nextcord.Guild, user: nextcord.User):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_member_unban"
        if not await self.has_logs(guild):
            return
        if 'moderation' not in self.get_flags(guild.id):
            return
    ...
    async def on_voice_state_update(self, member: nextcord.Member, before: nextcord.VoiceState, after: nextcord.VoiceState):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_voice_state_update"
        if not await self.has_logs(member.guild):
            return
        ...
        embed.colour = nextcord.Color.light_gray()
        embed.set_author(name=str(member), icon_url=member.avatar_url)
        _footer = await self.bot._(member.guild.id, "logs.footer3", member=member.id)
        embed.set_footer(text=_footer)
        await self.send_embed(member.guild, embed)
    ...
    async def on_guild_update(self, before: nextcord.Guild, after: nextcord.Guild):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_guild_update"
        ...
        if before.premium_tier != after.premium_tier:
            ...
            embed.description += "\n" + _desc
        embed.color = nextcord.Color(0xf47fff)
        await self.send_embed(after, embed)

    @commands.Cog.listener()
    async def on_guild_role_create(self, role: nextcord.Role):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_guild_role_create"
        ...
        if role.color != nextcord.Color.default():
    ...
    async def on_guild_role_delete(self, role: nextcord.Role):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_guild_role_delete"
        if not await self.has_logs(role.guild):
            return
        if 'roles' not in self.get_flags(role.guild.id):
            return
    ...
    async def on_guild_role_update(self, before: nextcord.Role, after: nextcord.Role):
        "https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_guild_role_update"
    ...
    async def on_member_update(self, before: nextcord.Member, after: nextcord.Member):
        """https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_member_update"""
        if not await self.has_logs(before.guild):
            return
        if 'members' not in self.get_flags(before.guild.id):
            return
        embed = nextcord.Embed(title=await self.bot._(after.guild.id, "logs.member_update.title"),
                              color=nextcord.Color(0xf8bd1c))
    ...
    @commands.Cog.listener()
    async def on_guild_emojis_update(self, guild: nextcord.Guild, before: List[nextcord.Emoji], after: List[nextcord.Emoji]):
        """https://discordpy.readthedocs.io/en/latest/api.html#nextcord.on_guild_emojis_update"""
        if not await self.has_logs(guild):
            return
        if 'emojis' not in self.get_flags(guild.id):
            return
        embed = nextcord.Embed(title=await self.bot._(guild.id, "logs.emoji_update.title"),
                              color=nextcord.Color(0xf8d71c))
